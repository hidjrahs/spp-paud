        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Transaksi Menabung</h3>
                </div>
                @if (session()->has('msg'))
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group" id="form-siswa">
        ...
        require(['jquery', 'sweetalert', 'select2'], function($, sweetalert, select2) {
            $(document).ready(function() {
                ...
                $('#submit').on('click', function() {
                    if ((saldo <= 0 && keperluan == 'out') || (saldo < jumlah && keperluan ==
                        'out')) {
                        swal({
                            title: 'tidak dapat melakukan penarikan, saldo ' + saldo +
                                ', dengan jumlah ' + jumlah,
                            dangerMode: true,
                        })
                    } else if (jumlah <= 99 && keperluan == 'in' || jumlah == undefined || $(
                            '#jumlah').val() <= 99) {
                        swal({
